...
/root/.nvm/versions/node/v<VERSION>/bin/npm install || { echo "Failed to install npm dependencies"; exit 1; }

# Restart the application using pm2
/root/.nvm/versions/node/v<VERSION>/bin/pm2 restart index.js || { echo "Failed to restart the application using pm2"; exit 1; }
EOF
